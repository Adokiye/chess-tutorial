...
export const famousGames: FamousGame[] = [
  ...
  },
  {
    ...
    description: "The pivotal game in the 2013 World Championship match. Carlsen sidestepped Anand's preparation, traded into a slightly better endgame, and then converted with relentless precision. It is one of the clearest examples of his ability to squeeze wins from positions that look close to equal.",
    keyMoments: [
      { moveIndex: 12, comment: 'Nxe3 gives Carlsen the bishop pair and a long-term structural target on c6.' },
      { moveIndex: 20, comment: "21.b7! is the point of White's queenside play — the advanced pawn forces concessions and secures a pleasant endgame." },
      { moveIndex: 34, comment: "35.Rh6! activates the rook and fixes Black's kingside weaknesses for the long haul." },
      { moveIndex: 47, comment: '48.Rh6+ keeps the king cut off. Carlsen never lets Anand coordinate counterplay.' },
      { moveIndex: 57, comment: '58.h4 leaves Black helpless against the connected passed pawns, and Anand resigned.' },
    ],
  },
  {
    id: 'legal-mate',
    title: "L'egal's Mate",
    white: "Sire de L'egal",
    black: 'Saint Brie',
    year: 1750,
    event: 'Paris',
    result: '1-0',
    pgn: '1. e4 e5 2. Nf3 Nc6 3. Bc4 d6 4. Nc3 Bg4 5. h3 Bh5 6. Nxe5 Bxd1 7. Bxf7+ Ke7 8. Nd5#',
    description: 'One of the oldest and most famous miniatures in chess. White appears to blunder the queen, but the real point is a mating net with the bishops and knight. It is a timeless lesson in piece activity and tactical vision.',
    keyMoments: [
      { moveIndex: 5, comment: '6.Nxe5! looks impossible at first glance because Black can take the queen.' },
      { moveIndex: 6, comment: '...Bxd1 grabs the queen, but Black has walked into a classic mating net.' },
      { moveIndex: 7, comment: '8.Nd5# ends the game immediately. Material means nothing when the king is mated.' },
    ],
  },
];
...
export const chessPuzzles: ChessPuzzle[] = [
  ...
  },
  {
    ...
    difficulty: 'beginner',
    theme: 'Checkmate in 1',
    hint: 'Use the queen on the open file to cut off every escape square.',
  },
  {
    id: 'mate-1-smothered',
  ...
  },
  {
    ...
    difficulty: 'beginner',
    theme: 'Checkmate in 1',
    hint: 'The queen can capture with check and still guard every flight square.',
  },
  ...
  },
  {
    ...
    description: 'White to move. Eliminate the key defender before winning material.',
    fen: '3r2k1/5ppp/8/8/3Q4/8/5PPP/6K1 w - - 0 1',
    toMove: 'w',
    solution: ['Qxd8+'],
    difficulty: 'intermediate',
    theme: 'Removal of the Guard',
    hint: 'The back-rank defender is overloaded. Trade it off first.',
  },
  {
  ...
  // --- ADVANCED: Forcing Tactics ---
  {
    id: 'greek-gift',
    title: 'Greek Gift Sacrifice',
    description: 'White to move. Start the attack with the classic bishop sacrifice.',
    fen: 'r1bq1rk1/ppp2ppp/2n2n2/3pp3/3P4/2PB1N2/PP3PPP/RNBQ1RK1 w - - 0 1',
    toMove: 'w',
    solution: ['Bxh7+'],
    difficulty: 'advanced',
    theme: 'Sacrifice',
    hint: 'When the king is castled and the knight can jump to g5, h7 is often the trigger square.',
  },
  {
    id: 'exchange-sacrifice',
    title: 'Exchange Sacrifice',
    description: 'White to move. Sacrifice material to rip open the king.',
    fen: '3r2k1/5ppp/8/8/8/8/5PPP/3R2K1 w - - 0 1',
    toMove: 'w',
    solution: ['Rxd8+'],
    difficulty: 'advanced',
    theme: 'Exchange Sacrifice',
    hint: 'The back rank is under-defended. Blow it open with check.',
  },
  {
    id: 'anastasia-pattern',
    title: 'Anastasia Pattern',
    description: 'White to move. Spot the finishing knight jump.',
    fen: '6rk/5ppp/7N/8/8/8/6PP/6RK w - - 0 1',
    toMove: 'w',
    solution: ['Nxf7#'],
    difficulty: 'advanced',
    theme: 'Checkmate Pattern',
    hint: 'The rook seals the back rank. The knight supplies the final check.',
  },
  {
  ...
  {
    id: 'back-rank-breakthrough',
    title: 'Quiet Mate',
    description: 'White to move. Find the calm finishing move.',
    fen: '6k1/5ppp/8/8/8/3Q4/5PPP/3R2K1 w - - 0 1',
    toMove: 'w',
    solution: ['Qd8#'],
    difficulty: 'advanced',
    theme: 'Quiet Move',
    hint: 'A direct queen move ends the game without needing any sacrifices.',
  },
];
