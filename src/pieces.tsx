...
export function WKing({ className }: PieceProps) {
  return (
...
export function WQueen({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
...
export function WRook({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
      <g fill="#fff" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5" strokeLinecap="butt"/>
        <path d="M34 14l-3 3H14l-3-3"/>
        <path d="M15 17v12.5h15V17" strokeLinecap="butt" strokeLinejoin="miter"/>
...
export function WBishop({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function WKnight({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function WPawn({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
...
export function BKing({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BQueen({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
...
export function BRook({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
      <g fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 39h27v-3H9v3zM12.5 32l1.5-2.5h17l1.5 2.5h-20zM12 36v-4h21v4H12z" fill="#000" strokeLinecap="butt"/>
...
export function BBishop({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BKnight({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BPawn({ className }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
...
const PIECE_COMPONENTS: Record<string, React.FC<PieceProps>> = {
  wk: WKing, wq: WQueen, wr: WRook, wb: WBishop, wn: WKnight, wp: WPawn,
  bk: BKing, bq: BQueen, br: BRook, bb: BBishop, bn: BKnight, bp: BPawn,
};

export function ChessPiece({ color, type, className }: { color: string; type: string; className?: string }) {
  const key = `${color}${type}`;
  const Component = PIECE_COMPONENTS[key];
